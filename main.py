...
def homepage():
	...
	city = LocationInfo("Dallas")
	timezone = city.timezone
	long = city.longitude
	lat = city.latitude
	date=datetime.strptime('2018-03-04', "%Y-%m-%d")
	suns=sun(city.observer, date=date)
	return render_template('home.html',cities=cities,city=city.name,region=city.region,timezone=timezone,long=long,lat=lat)
